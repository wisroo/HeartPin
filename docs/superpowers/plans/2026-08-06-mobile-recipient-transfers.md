...
- [ ] **Step 1: Write failing loading, populated, empty, and retry tests**
...
- [ ] **Step 3: Implement browser and display helpers plus read states**
...
- [ ] **Step 4: Run focused read-state tests to verify GREEN**

Run the focused test file and expect all read-state tests to pass.

- [ ] **Step 5: Write failing download and confirmation tests**
...
- [ ] **Step 6: Run interaction tests to verify RED**

Expected: FAIL because download and confirmation handlers are absent.

- [ ] **Step 7: Implement the minimal interaction state machine**
...
- [ ] **Step 8: Add scoped CSS and verify GREEN**
...
- [ ] **Step 9: Commit the screen slice**
...
- [ ] **Step 2: Run focused Profile test to verify RED**
...
- [ ] **Step 3: Add the Profile menu entry**
...
- [ ] **Step 4: Run focused Profile test to verify GREEN**

Expected: PASS.

- [ ] **Step 5: Write failing Mobile shell overlay test**
...
- [ ] **Step 6: Run focused Mobile shell test to verify RED**
...
- [ ] **Step 7: Wire the overlay in MobileShell**
...
- [ ] **Step 8: Run shell and combined Mobile tests to verify GREEN**
...
- [ ] **Step 1: Update only completed-scope documentation**
